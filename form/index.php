...
/*
Using rwbaker's repo. Link: https://github.com/rwbaker/PHP-Email-Form
...
$from_email = "";
/* Subject line */
$subject = "Contact from tristanlarsin.com";
/* Site URL */
$site_url = "http://www.tristanlarsin.com";
/* Site Name */
$site_name = "tristanlarsin.com";
/*
...
curl_setopt($ch, CURLOPT_POSTFIELDS,
            "secret=6LeDfywUAAAAAB0_VKg2pd-sudAeQELDSJBiDr0x&response=".$response);
...
// End of Google recaptcha test

// Start of mailing code

// Remove $_COOKIE elements from $_REQUEST.
if(count($_COOKIE)) {
	foreach(array_keys($_COOKIE) as $value){unset($_REQUEST[$value]);}
}
...
<body>
	<div id="thankyou">
		<p><strong>Thank you for contacting me, your message has been sent.</strong></p>
